...
const double MOVIES_LEN_TEMPORAL_ETA = 0.001;
const double MOVIES_LEN_TEMPORAL_LAMBDA = 0.01;
const double MOVIES_LEN_TEMPORAL_NSTEP = 30;

const double MOVIES_LEN_NEIGHBOR_ETA = 0.003;
const double MOVIES_LEN_NEIGHBOR_LAMBDA = 0.03;
const double MOVIES_LEN_NEIGHBOR_NSTEP = 30;
